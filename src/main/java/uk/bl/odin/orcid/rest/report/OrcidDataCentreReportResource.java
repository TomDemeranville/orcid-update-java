...
public class OrcidDataCentreReportResource extends SelfInjectingServerResource {
	...
	/**
	 * Parse the query. Expects datatable query params: iDisplayStart
	 * iDisplayLength sSearch sEcho
	 * 
	 * also optionally expects idtype (defaults to doi) searchtype (defaults to
	 * prefix)
	 * 
	...
	/**
	 * Get a datatable representation of the search results. Suitable for use
	 * with http://datatables.net/ Caches results with provided CacheManager
	 */
	@Get("json")
